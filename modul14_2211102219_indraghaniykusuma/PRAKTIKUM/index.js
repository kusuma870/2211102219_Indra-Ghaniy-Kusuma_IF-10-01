// INDRA GHANIY KUSUMA ( 2211102219 ) 
// 2.1. Deklarasi Variabel
var nama = "INDRA GHANIY KUSUMA"; // Global scope
...
// Object
let person = { nama: "INDRA GHANIY KUSUMA", umur: 22 };
// Undefined
let belumDefinisi;
// Null
let kosong = null;
...
console.log(sapa("INDRA GHANIY KUSUMA"));

// 4.2. Objek
const mahasiswa = {
  nama: "INDRA GHANIY KUSUMA",
  umur: 21,
  sapa: function() {
